 ...
 * mån  8 aug 2011 14.47.26 CEST 
 * compat-wireless-2.6: compat-wireless-v2.6.39-1
 * linux-2.6: v2.6.39
 */
#define COMPAT_RELEASE "compat-wireless-v2.6.39-1"
#define COMPAT_KERNEL_RELEASE "v2.6.39"
